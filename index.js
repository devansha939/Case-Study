...
function displayData() {
    ...
    for (var i = 0; i < userContacts.length; i++)
    {
        temp +=
          "<tr><td>" +
          userContacts[i].phone +
          "</td><td>" +
          userContacts[i].email +
          "</td><td>" +
          '<a onclick ="deleteContact(\'' +
          userContacts[i].name +
          '\')" class="text-danger"><i class="fas fa-minus-circle"></i></a>'+"</td><td>"+'<a href="#" class="text=white"><i class ="fas fa envelope"></i></a>'+"</td></tr>";
    }
...
function validateEmail() {
  var regex = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\ .,;:\s@"]+)*)|(".+"))@(([0-9]{1,3}\.[0,9]{1,3}\])|(([a-zA-z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
